...
: NUM_GAME_STATES(3)
{
	...
	//gameStateTable[GAME_STATE_STAGE_2] = new CGameStateStage_2(this);
	//gameStateTable[GAME_STATE_OVER_2] = new CGameStateOver2(this);
	//gameStateTable[GAME_STATE_STAGE_3] = new CGameStateStage_3(this);
	gameState = NULL;
}
